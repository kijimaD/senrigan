...
export type CameraInfoStatusEnum =
  (typeof CameraInfoStatusEnum)[keyof typeof CameraInfoStatusEnum];
 ...
 * @export
 */
export const CameraApiAxiosParamCreator = function (
  ...
  return {
    ...
    getCameraStream: async (
      ...
      const localVarPath = `/api/cameras/{cameraId}/stream`.replace(
        `{${"cameraId"}}`,
        encodeURIComponent(String(cameraId)),
      );
...
export const CameraApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getCameraStream(
        cameraId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CameraApi.getCameraStream"]?.[
    ...
    async getCameras(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CamerasResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCameras(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CameraApi.getCameras"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const CameraApiFactory = function (
  ...
  return {
    ...
    getCameraStream(
      ...
      return localVarFp
        .getCameraStream(cameraId, options)
...
export class CameraApi extends BaseAPI {
  ...
  public getCameraStream(cameraId: string, options?: RawAxiosRequestConfig) {
    return CameraApiFp(this.configuration)
      .getCameraStream(cameraId, options)
...
export const StatusApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["StatusApi.getStatus"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
